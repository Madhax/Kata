    ...
    def strongPasswordChecker(self, password: str) -> int:
        ...
        def dp(index, length, hasLowerCase, hasUpperCase, hasDigit, consecutives, prevChar):
            ...
            if index == len(password):
                ...
                if hasLowerCase == True and hasUpperCase == True and hasDigit == True:
                    return 0
                else:
                    return math.inf
            ...
            #consecutives 
            best = min(best, dp(index+1, length+1, newHasLowerCase, newHasUpperCase, newHasDigit, consecutives + (password[index] == prevChar) if (password[index] == prevChar) else 0  , password[index]))
